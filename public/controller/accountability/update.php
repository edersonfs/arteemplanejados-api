...
try {
    ...
    // initialize object
    $accountability = new Accountability($db);
    ...
    if ($accountability->existsByNameWhenEdit($data['name'], $data['id'])) {
        echo json_encode([
    ...
    if ($accountability->update($data)) {
        echo json_encode(['accountability' => []]);
    } else {
