...
try {
    ...
    $oldRow = $orderItem->getById($_POST['id']);
    if (!$oldRow) {
    ...
    $orderId = isset($_POST['order_id']) ? (int) $_POST['order_id'] : (int) $oldRow['order_id'];
    ...
    $data = [
        ...
        'discount_for_stock' => $_POST['discount_for_stock'] ?? $oldRow['discount_for_stock'] ?? null,
