...
try {        
    ...
    // Take old images
    $oldNews = $news->getById($_POST['id']);
    
    // Handle top image upload if provided
    $image_file = $oldNews['image_file'];
    ...
    $image_file_02 = $oldNews['image_file_02'];
    $image_path_02 = $oldNews['image_path_02'];;
    ...
    // Handle description image upload if provided
    $image_file_03 = $oldNews['image_file_03'];
    $image_path_03 = $oldNews['image_path_03'];;
    ...
    // Handle description image upload if provided
    $image_file_04 = $oldNews['image_file_04'];
    $image_path_04 = $oldNews['image_path_04'];;
    ...
    if ($news->existsByTitleWhenEdit($data['title'], $data['id'])) {
      echo json_encode([
