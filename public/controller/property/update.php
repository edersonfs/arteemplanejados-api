...
try {        
    ...
    // Take old images
    $oldProperty = $property->getById($id);
    
    // Handle top image upload if provided
    $image_file = $oldProperty['image_file'];
    $image_path = $oldProperty['image_path'];;
    ...
    $image_file_02 = $oldProperty['image_file_02'];
    $image_path_02 = $oldProperty['image_path_02'];;
    ...
    $image_file_03 = $oldProperty['image_file_03'];
    $image_path_03 = $oldProperty['image_path_03'];
    ...
    $image_file_04 = $oldProperty['image_file_04'];
    $image_path_04 = $oldProperty['image_path_04'];
    ...
    $image_file_05 = $oldProperty['image_file_05'];
    $image_path_05 = $oldProperty['image_path_05'];
    ...
    $image_file_06 = $oldProperty['image_file_06'];
    $image_path_06 = $oldProperty['image_path_06'];
    ...
    $image_file_07 = $oldProperty['image_file_07'];
    $image_path_07 = $oldProperty['image_path_07'];
    ...
    $image_file_08 = $oldProperty['image_file_08'];
    $image_path_08 = $oldProperty['image_path_08'];
    ...
    $image_file_09 = $oldProperty['image_file_09'];
    $image_path_09 = $oldProperty['image_path_09'];
    ...
    $image_file_10 = $oldProperty['image_file_10'];
    $image_path_10 = $oldProperty['image_path_10'];
    ...
    $image_file_11 = $oldProperty['image_file_11'];
    $image_path_11 = $oldProperty['image_path_11'];
    ...
    $image_file_12 = $oldProperty['image_file_12'];
    $image_path_12 = $oldProperty['image_path_12'];
    ...
    $image_file_13 = $oldProperty['image_file_13'];
    $image_path_13 = $oldProperty['image_path_13'];    
    ...
    $image_file_14 = $oldProperty['image_file_14'];
    $image_path_14 = $oldProperty['image_path_14'];
    ...
    $image_file_15 = $oldProperty['image_file_15'];
    $image_path_15 = $oldProperty['image_path_15'];
    ...
    $data = [
        ...
        'rented' => $_REQUEST['rented'] ?? null,
        'value' => $_REQUEST['value'] ?? null,
        'tenant' => $_REQUEST['tenant'] ?? null,
        'contact' => $_REQUEST['contact'] ?? null,
        'rental_start_date' => $_REQUEST['rental_start_date'] ?? null,
        'rental_end_date' => $_REQUEST['rental_end_date'] ?? null,
    ...
    if ($property->existsByNameWhenEdit($data['name'], $data['id'])) {
      echo json_encode([
