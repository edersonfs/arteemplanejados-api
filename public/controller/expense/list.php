...
try {
  ...
  $stmt = $expense->getAll($company_id, $order_id, $material_id, $order_item_id);
  $stmt_pag = $expense->getPagination($limit, $offset, $company_id, $order_id, $material_id, $order_item_id);
