...
try {
  ...
  $internal_client_id = isset($_GET['internal_client_id']) ? intval($_GET['internal_client_id']) : 0;
  ...
  $stmt = $budget->getAll($group_id, $company_id, $internal_client_id);
  $stmt_pag = $budget->getPagination($limit, $offset, $group_id, $company_id, $internal_client_id);
