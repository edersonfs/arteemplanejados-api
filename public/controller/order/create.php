...
try {
    ...
    $internalClientId = isset($_POST['internal_client_id']) && $_POST['internal_client_id'] !== ''
        ? (int) $_POST['internal_client_id']
        : null;

    $budgetId = isset($_POST['budget_id']) && $_POST['budget_id'] !== ''
        ? (int) $_POST['budget_id']
        : null;
    ...
    if (!empty($data['number']) && $order->existsByNumber($data['number'], $companyId)) {
        echo json_encode([
