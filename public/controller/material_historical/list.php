...
try {
    ...
    $stmt = $materialHistorical->getAll($company_id, $material_id);
    $stmt_pag = $materialHistorical->getPagination($limit, $offset, $company_id, $material_id);
